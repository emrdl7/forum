...
function HomePage() {
  ...
  return (
    <div className="md:before:block md:before:w-[1170px] md:before:h-[1px] md:before:bg-[#fff] md:before:opacity-50 md:before:fixed md:before:top-[149px] md:before:z-[400] md:before:left-[50%] md:before:translate-x-[-50%]">
      {/* 크로스페이드 슬라이드 영역 */}

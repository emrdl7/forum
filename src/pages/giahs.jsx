...
function HomePage() {
  ...
  return (
    <div className="container">
      ...
      <div className="mb-8 bg-[url('assets/images/map02.svg')] bg-[] bg-no-repeat bg-center bg-[length:320px_auto] pt-[270px] text-[0px]  md:bg-[length:1014px_auto] md:pt-[840px]">
            지도
      </div>
